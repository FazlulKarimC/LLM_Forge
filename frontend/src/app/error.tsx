    ...
    <div className="page-width flex min-h-[70vh] items-center justify-center px-4 py-8 sm:px-6">
      <div className="panel max-w-2xl p-6 sm:p-8">
        <div className="flex flex-col gap-6 sm:flex-row sm:items-start">
          <div className="flex size-14 items-center justify-center rounded-[20px] border border-[var(--border)] bg-[var(--destructive-soft)] text-[color:color-mix(in_oklab,var(--destructive)_84%,white_12%)]">
          ...
          <div className="flex-1 space-y-5">
            ...
            {error.details?.length ? (
              <div className="alert alert-danger">
                <div className="space-y-2">
                  <div className="section-label text-[color:color-mix(in_oklab,var(--destructive)_84%,white_12%)]">Validation details</div>
                  <ul className="space-y-2 text-sm leading-6 text-[color:color-mix(in_oklab,var(--destructive)_84%,white_12%)]">
